...
{/* ==== new invoice body ==== */}
     <div className='new__invoice-body'>
        ...
        <div className='form__group'>
            <p>Street Address</p>
            <input type="text" value={senderStreet} onChange={e => setSenderStreet(e.target.value)} />
        </div>
...
<div className='bill__to'>
        ...
        <div className='form__group'>
            <p>Street Address</p>
            <input type="text" value={clientStreet} onChange={e => setClientStreet(e.target.value)}/>
        </div>
        ...
        <div className='form__group inline__form-group'>
            ...
            <div>
                <p>Postal Code</p>
                <input type="text" value={clientPostalCode} onChange={e => setClientPostalCode(e.target.value)}/>
            </div>
