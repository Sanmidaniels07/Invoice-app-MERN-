...
async function handler(req, res){
    ...
    const client = await MongoClient.connect('mongodb+srv://sanmi0704:Q1KnmQfvzrbsy6eY@cluster0.0cfollw.mongodb.net/invoices?retryWrites=true&w=majority', { useNewUrlParser: true})
